package com.example.loinsekali;
...
/*
    public static String getKeyUserTeregister(Context context) {
        return KEY_USER_TEREGISTER;
    }

    public static String getKeyPassTeregister(Context context) {
    ...
    public static String getKeyStatusSedangLogin(Context context) {
